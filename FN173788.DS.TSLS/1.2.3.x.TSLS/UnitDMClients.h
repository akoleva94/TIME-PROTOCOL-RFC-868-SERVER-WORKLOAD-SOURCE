...
//---------------------------------------------------------------------------
#define LOG_MODE 1
// 0 - не поддържа протокол (използва се замо за оценка на внасяната грешка)
// 1 - визуализиране на протокола след приключване на синхронизацията
// 2 - визуализиране на протокола по време на синхронизацията
//---------------------------------------------------------------------------
